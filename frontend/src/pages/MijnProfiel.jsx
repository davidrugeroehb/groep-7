...
function MijnProfiel() {
  ...
  return (
    ...
    <div className="min-h-screen flex justify-center items-start bg-gray-50 pt-10">
      {/* centreert hele pagina en de inhoud */}


      <div className='max-w-lg w-full flex-col gap-2 text-sm p-6 bg-white shadow-md rounded-xl'>
        {/* Deze div is de "kaart" met je profielgegevens */}


        <p className='font-medium text-3xl text-neutral-800 mt-4 text-center'>Jouw profiel</p>
        ...
        {/*Buttons voor bewerken en opslaan van eigen gegevens*/}
        <div className='mt-10'>
          {
            wijzig ? <button className='border border-blue-600 px-8 py-2 rounded-full bg-blue-600 text-white hover:bg-white hover:text-blue-600 transition-all' onClick={() => setWijzig(false)}>Gegevens Opslaan</button>
              : <button className='border border-blue-600 px-8 py-2 rounded-full bg-blue-600 text-white hover:bg-white hover:text-blue-600 transition-all' onClick={() => setWijzig(true)}>Bewerk</button>
          }
        </div>
