    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto bg-white shadow-md rounded-xl p-8 border border-gray-200">
            ...
            <p className="text-gray-700 mb-6 leading-relaxed">
              ...
              We verbinden studenten en bedrijven op een vlotte en efficiënte manier via speeddates.</p>
        </div>
        <img src="../assets/basis.png" alt="foto van studenten van ehb die praten met een verandwoordelijke van een bedrijf" className="mt-8 max-w-full w-full md:w-2/3 rounded-xl shadow-md object-cover" />
